...
public class Main extends Application {
    ...
    private void aboutMe() {
        ...
        alert.setHeaderText("Daksh Raj");
        alert.setContentText("I love to play around with code and create games, this is my first experience of designing. I hope you like it.Play Connect4 in free time to enjoy ur time.");
        alert.show();
    }
